 ...
 * </p>
 * <ul>
 *   <li>{@link gr1616.impl.HumanImpl#getInventory <em>Inventory</em>}</li>
 *   <li>{@link gr1616.impl.HumanImpl#getPerson <em>Person</em>}</li>
 *   <li>{@link gr1616.impl.HumanImpl#getNickname <em>Nickname</em>}</li>
 *   <li>{@link gr1616.impl.HumanImpl#getXp <em>Xp</em>}</li>
 *   <li>{@link gr1616.impl.HumanImpl#getAttackPoints <em>Attack Points</em>}</li>
 *   <li>{@link gr1616.impl.HumanImpl#getActiveWeapon <em>Active Weapon</em>}</li>
 *   <li>{@link gr1616.impl.HumanImpl#getActiveArmor <em>Active Armor</em>}</li>
 *   <li>{@link gr1616.impl.HumanImpl#getGold <em>Gold</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HumanImpl extends GeoLocationImpl implements Human {
	/**
	...
	protected EClass eStaticClass() {
		return Gr1616Package.Literals.HUMAN;
	}
	...
	public EList<Item> getInventory() {
		if (inventory == null) {
			inventory = new EObjectResolvingEList<Item>(Item.class, this, Gr1616Package.HUMAN__INVENTORY);
		}
		return inventory;
	}
		...
		if (person != null && person.eIsProxy()) {
			...
			if (person != oldPerson) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Gr1616Package.HUMAN__PERSON, oldPerson, person));
			}
		}
		return person;
	}
	...
	public void setPerson(Person newPerson) {
		...
		person = newPerson;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gr1616Package.HUMAN__PERSON, oldPerson, person));
	}
	...
	public void setNickname(String newNickname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gr1616Package.HUMAN__NICKNAME, oldNickname, nickname));
	}
	...
	public void setXp(int newXp) {
		...
		xp = newXp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gr1616Package.HUMAN__XP, oldXp, xp));
	}
	...
	public void setAttackPoints(int newAttackPoints) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gr1616Package.HUMAN__ATTACK_POINTS, oldAttackPoints, attackPoints));
	}
	...
	public WeaponClass getActiveWeapon() {
		if (activeWeapon != null && activeWeapon.eIsProxy()) {
			...
			if (activeWeapon != oldActiveWeapon) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Gr1616Package.HUMAN__ACTIVE_WEAPON, oldActiveWeapon, activeWeapon));
			}
		}
		return activeWeapon;
	}
	...
	public void setActiveWeapon(WeaponClass newActiveWeapon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gr1616Package.HUMAN__ACTIVE_WEAPON, oldActiveWeapon, activeWeapon));
	}
	...
	public ArmorClass getActiveArmor() {
		if (activeArmor != null && activeArmor.eIsProxy()) {
			...
			if (activeArmor != oldActiveArmor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Gr1616Package.HUMAN__ACTIVE_ARMOR, oldActiveArmor, activeArmor));
			}
		}
		return activeArmor;
	}
	...
	public void setActiveArmor(ArmorClass newActiveArmor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gr1616Package.HUMAN__ACTIVE_ARMOR, oldActiveArmor, activeArmor));
	}
	...
	public void setGold(int newGold) {
		...
		gold = newGold;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gr1616Package.HUMAN__GOLD, oldGold, gold));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gr1616Package.HUMAN__INVENTORY:
				return getInventory();
			case Gr1616Package.HUMAN__PERSON:
				if (resolve) return getPerson();
				return basicGetPerson();
			case Gr1616Package.HUMAN__NICKNAME:
				return getNickname();
			case Gr1616Package.HUMAN__XP:
				return getXp();
			case Gr1616Package.HUMAN__ATTACK_POINTS:
				return getAttackPoints();
			case Gr1616Package.HUMAN__ACTIVE_WEAPON:
				if (resolve) return getActiveWeapon();
				return basicGetActiveWeapon();
			case Gr1616Package.HUMAN__ACTIVE_ARMOR:
				if (resolve) return getActiveArmor();
				return basicGetActiveArmor();
			case Gr1616Package.HUMAN__GOLD:
				return getGold();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbleToHold.class) {
			switch (derivedFeatureID) {
				case Gr1616Package.HUMAN__INVENTORY: return Gr1616Package.ABLE_TO_HOLD__INVENTORY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbleToHold.class) {
			switch (baseFeatureID) {
				case Gr1616Package.ABLE_TO_HOLD__INVENTORY: return Gr1616Package.HUMAN__INVENTORY;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Gr1616Package.HUMAN___GET_RACE_GOOD_AGAINST:
				return getRaceGoodAgainst();
			case Gr1616Package.HUMAN___GET_AFFRAID_OF:
				return getAffraidOf();
		}
